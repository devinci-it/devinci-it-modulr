...
<label class="modulr-radio modulr-radio--<?= htmlspecialchars($size, ENT_QUOTES, 'UTF-8') ?>" for="<?= htmlspecialchars($id, ENT_QUOTES, 'UTF-8') ?>">
    <input<?= $renderAttributes($attributes) ?>>
    <span class="modulr-radio__label"><?= htmlspecialchars($label, ENT_QUOTES, 'UTF-8') ?></span>
</label>

<?php if (!empty($helperText)): ?>
    <p id="<?= htmlspecialchars($id . '-help', ENT_QUOTES, 'UTF-8') ?>" class="modulr-radio__help">
